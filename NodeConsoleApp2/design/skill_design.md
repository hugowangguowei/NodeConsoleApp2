...
| **野蛮冲撞 (Savage Charge)** | 稀有 | 4 | 对躯干造成中等伤害。如果此攻击令护甲归零，则击退敌人（下回合速度 -10）。 | 初始化战场节奏，压制高速敌人。 |
| **碎颅重击 (Skull Cracker)** | 稀有 | 4 | 对头部造成 150% 物理伤害。若头部有护甲，额外造成 30 点破甲伤害。 | 针对重头盔敌人的专项打击。 |
| **震荡波 (Shockwave)** | 卓越 | 4 | 猛击地面，对敌人所有部位造成少量伤害并减少其 10 点速度 (1回合)。 | AOE 减速，用于应对多部位护甲敌人。 |
| **处决 (Execute)** | 卓越 | 3 | 只能对 HP < 30% 的目标使用。造成 300% 的巨额真实伤害。 | 斩杀技能，快速结束战斗。 |
| **大地震击 (Earthquake)** | 史诗 | 5 | 对所有部位造成 40 点破甲伤害，并有 50% 概率对头部造成 [眩晕]。 | 强力开团技能，剥离敌人护甲。 |
| **狂暴姿态 (Berserk)** | 史诗 | 3 | [Buff] 下 2 回合造成的伤害提升 50%，但自身所有部位护甲减少 50%。 | 爆发阶段使用，舍弃防御换取输出。 |
| **诸神黄昏 (Ragnarok)** | 传说 | 6 | 对所有部位造成毁灭性打击 (200% ATK)，且该攻击具有 100% 的破甲效率。 | 终极毁灭技。 |
...
| **尖刺防御 (Spiked Shell)** | 稀有 | 3 | [Buff] 获得反伤状态 2 回合：近战攻击你的敌人每次受到 15 点物理伤害。 | 针对高频低伤的近战敌人。 |
| **重整旗鼓 (Regroup)** | 稀有 | 3 | 恢复所有肢体 (四肢) 10 点护甲值，并解除流血状态。 | 应对 AOE 磨血和 Dot 伤害。 |
| **反击姿态 (Counter Stance)** | 卓越 | 3 | [Buff] 本回合若成功闪避或格挡了攻击，立即对攻击者发动一次 100% 伤害的反击。 | 防守反击的核心组件。 |
| **无谓挣扎 (Futile Struggle)** | 卓越 | 3 | [Debuff] 目标造成的伤害如果被护甲完全抵消，则其自身 AP -1 (持续 2 回合)。 | 惩罚低穿透力的敌人。 |
| **盾墙 (Shield Wall)** | 史诗 | 5 | [Buff] 本回合护甲值视为由所有部位共享 (分摊伤害)，且下回合 AP +3。 | 牺牲本回合换取下回合的爆发。 |
| **不朽壁垒 (Immortal Bastion)** | 史诗 | 4 | [Buff] 2 回合内，护甲无法被破坏 (最低保持为 1)。 | 防止破甲后的暴击或真实伤害。 |
| **绝对防御 (Aegis)** | 传说 | 5 | [Buff] 本回合免疫所有伤害，并将其转化为等量的 HP 治疗。 | 扭转局势的神技。 |
...
| **放血 (Bloodletting)** | 稀有 | 3 | 攻击躯干。如果敌人已有流血状态，流血层数 +1，并刷新持续时间。 | 维持并加深伤口。 |
| **剑舞 (Blade Dance)** | 稀有 | 3 | 对随机部位发动 3 次攻击，每次造成 50% 伤害。若全部命中，自身速度 +3。 | 叠流血并提升自身机动性。 |
| **弱点突刺 (Precision Thrust)** | 卓越 | 3 | 必定暴击 (1.5x)。只能攻击护甲已破损的部位。 | 针对性收割。 |
| **鲜血渴望 (Bloodthirst)** | 卓越 | 2 | [Passive Buff] 2 回合内，每当流血效果造成伤害，自身回复 5 点 HP。 | 续航手段，吸血流核心。 |
| **血腥收割 (Bloody Harvest)** | 史诗 | 3 | 攻击敌人。若敌人处于流血状态，造成额外 50% 伤害，并结算其剩余流血伤害的 50%。 | 引爆 Dot 造成爆发伤害。 |
| **猩红终结 (Crimson Finale)** | 史诗 | 4 | 移除目标所有流血层数。每移除一层，造成 30 点真实伤害。 | Dot 流派的终结技。 |
| **千刃风暴 (Thousand Cuts)** | 传说 | 5 | 对目标进行 10 次微量攻击，每次攻击有 20% 概率施加一层 [流血 I]。 | 瞬间叠满流血层数。 |
...
| **战术翻滚 (Tactical Roll)** | 稀有 | 2 | [Buff] 闪避率提升 30%，且下一次攻击技能 AP 消耗 -1。 | 调整位置，攻防转换。 |
| **疾风箭 (Wind Arrow)** | 稀有 | 3 | 必定先手 (Priority +1)。如果比敌人先行动，造成 180% 伤害。 | 利用高速度优势打爆发。 |
| **毒液涂层 (Poison Coating)** | 卓越 | 2 | [Buff] 本回合内，所有远程攻击附带 [中毒 I] (叠层)。 | 配合多段射击技能瞬间叠毒。 |
| **肾上腺素 (Adrenaline)** | 卓越 | 0 | 立即获得 2 点 AP，但下回合 AP 上限 -2。 | 透支未来 AP 进行当前爆发。 |
| **极速连击 (Rapid Fire)** | 史诗 | 4 | 射出 5 支箭，每支造成 40% 伤害，随机分配给未被破坏的部位。 | 类似于近战的千刃，针对远程。 |
| **残影 (Afterimage)** | 史诗 | 4 | [Buff] 闪避率提升 60%，持续 2 回合。闪避成功时回复 1 AP。 | 极高的生存能力与资源回复。 |
| **时空扭曲 (Time Warp)** | 传说 | 6 | 立即获得一个新的回合 (Extra Turn)，但该额外回合只有一半的 AP 上限。 | 极其强大的战术技能。 |
...
| **致残射击 (Crippling Shot)** | 稀有 | 3 | 攻击四肢。造成伤害后，使该部位功能失效 (攻击力降低或移动受限)。 | 软控场。 |
| **远程拆解 (Disarm)** | 稀有 | 3 | 对手臂造成 200% 的护甲伤害。若护甲被破，敌人攻击力 -30% (1回合)。 | 针对高攻敌人。 |
| **穿甲射击 (Piercing Bolt)** | 卓越 | 3 | 无视目标 50% 的护甲值直接造成伤害。 | 对抗重甲单位的标准手段。 |
| **爆头 (Headshot)** | 卓越 | 4 | 对头部造成 200% 伤害。命中率修正 -20%，但若命中必定暴击。 | 高风险高回报。 |
| **幽灵狙击 (Ghost Snipe)** | 史诗 | 4 | [无法闪避] 且无视 100% 护甲，但也无法暴击。造成固定 150% 面板伤害。 | 稳定且致命的真实伤害。 |
| **鹰眼 (Eagle Eye)** | 史诗 | 3 | [Passive Buff] 接下来的 3 回合，你的攻击不再受距离惩罚，且最小伤害值提升。 | 提升输出稳定性。 |
| **致命一击 (One Shot One Kill)** | 传说 | 6 | [蓄力] 需要上一回合未使用攻击技能。对目标造成当前 HP 50% 的伤害 (Boss 效果减半)。 | 针对血牛型敌人的终极手段。 |
...
| **冰锥术 (Ice Lance)** | 稀有 | 3 | 造成冰霜伤害，无视 20% 护甲，并有 25% 概率 [冰冻] 敌人。 | 兼顾穿透与控制。 |
| **火焰之环 (Ring of Fire)** | 稀有 | 3 | 对自身周围造成 AOE 火焰伤害，自身受到少量反噬伤害。 | 近身防御手段。 |
| **冰霜新星 (Frost Nova)** | 卓越 | 3 | 对敌人所有部位造成冷冻伤害，并强制敌人本回合无法使用 AP > 3 的技能。 | 关键时刻封锁敌人大招。 |
| **过载 (Overload)** | 卓越 | 0 | 消耗 20% 当前 HP，本回合魔法伤害提升 50%。 | 爆发前置，以血换蓝。 |
| **闪电链 (Chain Lightning)** | 史诗 | 4 | 对敌人随机 3 个部位造成雷电伤害。若目标 [潮湿] 或穿戴金属盔甲，伤害 +50%。 | 对抗金属怪物的利器。 |
| **暴风雪 (Blizzard)** | 史诗 | 5 | 引导 1 回合，下回合对敌人所有部位造成 3 段冰霜伤害，每段都有高概率冻结敌人。 | 强力控场 AOE。 |
| **陨石术 (Meteor Swarm)** | 传说 | 6 | [延迟] 下回合开始时，一颗陨石砸向战场，对敌人所有部位造成毁灭性火伤并大幅削减护甲。 | 改变战场局势的终极魔法。 |
...
| **信仰之盾 (Shield of Faith)** | 稀有 | 3 | 增加 20 点临时护甲，且每回合结束时若护甲未破，回复 5 点 HP。 | 持续防御与缓回。 |
| **痛苦压制 (Pain Suppression)** | 稀有 | 3 | [Buff] 受到的所有伤害减少 30%，持续 3 回合。 | 强力减伤。 |
| **净化之火 (Cleansing Fire)** | 卓越 | 3 | 解除自身所有 Debuff，每解除一个，回复 15 点 HP 并对敌人造成等量伤害。 | 攻守兼备的解控技。 |
| **神圣震击 (Holy Shock)** | 卓越 | 3 | 对敌人造成伤害，同时治疗自己等量的生命值。 | 瞬间拉开血量差。 |
| **天使守护 (Guardian Angel)** | 史诗 | 5 | [Buff] 2 回合内，生命值无法低于 1。效果结束后回复 20% 最大 HP。 | 绝对的免死金牌。 |
| **光辉复苏 (Radiant Revitalize)** | 史诗 | 4 | 移除所有 Debuff，并回复大量 HP 和少量护甲。 | 自身重置状态。 |
